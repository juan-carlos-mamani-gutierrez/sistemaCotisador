...
?>
  ...
  <head>
    ...
    <title> Categoria | Cotizador </title>
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb float-xl-right">
          ...
          <li class="breadcrumb-item active"><a href="javascript:;">Categoria</a></li>

        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Categoria <small>Registro, Modificacion y Eliminacion de Registros </small></h1>
        <!-- end page-header -->
        <!-- begin panel -->

...
?>
  ...
  <head>
    ...
    <title> Producto | Cotizador </title>
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb float-xl-right">
          ...
          <li class="breadcrumb-item active"><a href="javascript:;">Producto</a></li>

        </ol>
        <!-- TODO titulo -->
        <h1 class="page-header">Producto <small>Registro, Modificacion y Eliminacion de Registros </small></h1>
        <!-- end page-header -->
        <!-- TODO panel -->
        <div class="panel panel-inverse">
          <div class="panel-heading">
            <h4 class="panel-title">Mantenimiento de Producto</h4>
